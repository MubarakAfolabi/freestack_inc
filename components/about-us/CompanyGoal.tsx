export default function CompanyGoal() {
  return (
    <section className="bg-[hsla(212,52%,14%,1)] text-white flex flex-col gap-4 p-4">
      <h2 className="text-2xl font-bold">Company Goal</h2>
      <p className="text-[hsla(215,16%,47%,1)]">
        Our goal is simple: to help football organizations become more
